...
public class FestivalMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if(intent!=null&&intent.getExtras()!=null) {
            ...
            LatLng UserLoc = new LatLng(Double.parseDouble(longi), Double.parseDouble(lat));
            Marker marker26 = googleMap.addMarker(new MarkerOptions().
                    position(UserLoc)
                    .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
            String id26 = marker26.getId();
